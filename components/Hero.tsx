    ...
    <section className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden">
      ...
      <div className="container mx-auto px-6 text-center z-10">
        ...
        >
          ...
          >
            What We Build Next Solutions transforms complex business challenges
            into seamless, high-performance digital architectures. From concept
            to scale, we engineer excellence.
          </motion.p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            ...
            <a href="https://www.instagram.com/whatwebuildnext?igsh=czZ0aDFvdGZnenB3" target="_blank">
              <MagneticButton className="w-full sm:w-auto px-10 py-5 bg-white/5 border border-white/10 text-white font-bold rounded-2xl flex items-center justify-center gap-3 hover:bg-white/10 transition-all backdrop-blur-md">
        ...
        >
          ...
          <code className="text-[13px] font-mono leading-relaxed block overflow-hidden">
            ...
            >
              ...
              <br />
              &nbsp;&nbsp;&nbsp;&nbsp;
              <span className="text-blue-400">this</span>.quality ={" "}
              <span className="text-green-400">Infinity</span>;<br />
              &nbsp;&nbsp;&nbsp;&nbsp;
              <span className="text-blue-400">this</span>.innovation ={" "}
              <span className="text-green-400">true</span>;<br />
              &nbsp;&nbsp;<span className="text-yellow-400">{"}"}</span>
              <br />
              <span className="text-yellow-400">{"}"}</span>
            </motion.div>
