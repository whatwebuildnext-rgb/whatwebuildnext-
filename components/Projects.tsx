    ...
    <section id="projects" className="py-24 bg-black/30">
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-4">
          <div>
            <h2 className="text-4xl md:text-5xl font-black mb-4">Case Studies</h2>
            <p className="text-slate-400 max-w-md">
              A selection of our most ambitious projects, delivered with precision and flair.
            </p>
          </div>
              ...
              <div className="absolute bottom-0 left-0 p-8 w-full">
                <div className="flex gap-2 mb-3">
                  {project.tags.map(tag => (
                    <span key={tag} className="px-3 py-1 text-[10px] bg-blue-600 rounded-full font-bold">
                      {tag}
                    </span>
                  ))}
                </div>
