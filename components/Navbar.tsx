    ...
    <>
      ...
      >
        <div className="container mx-auto px-6 flex items-center justify-between">
          ...
          {/* Mobile Toggle */}
          <button className="lg:hidden text-white z-50 relative" onClick={() => setIsOpen(!isOpen)}>
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div 
            ...
            className="fixed inset-0 bg-slate-900/95 backdrop-blur-xs lg:hidden z-40 flex flex-col items-center justify-center gap-8 px-6"
          ...
          >
            ...
            <motion.button
              ...
              onClick={(e) => scrollToSection(e, '#contact')}
              className="mt-4 px-10 py-4 rounded-2xl bg-blue-600 text-white font-black uppercase tracking-widest hover:bg-blue-700 transition-colors"
            >
              Get a Quote
            </motion.button>
          </motion.div>
